                    ...
                    Row(
                      children: [
                        ClipRRect(
                            ...
                            child : Image.network(controller.detailReviewData.data.reviews[index].image.toString(),width: 10.w,height: 10.w,fit: BoxFit.cover,)
                        ),
                        const SizedBox(width: 20,),
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            addText(controller.detailReviewData.data.reviews[index].name.toString(), getNormalTextFontSIze(), colorConstants.black, FontWeight.bold),
                            RatingBar.builder(
                              itemSize: 15,
