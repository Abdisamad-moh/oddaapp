  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: Container(
          color: colorConstants.white, child: const AppBottomNavigation()),
      body: SafeArea(
        child: Container(
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: LightAppHeader(title: controller.title.value),
              ),
              const SizedBox(
                height: 20,
              ),
              if (!controller.isBanner.value)
                GestureDetector(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        //this code is commented in 29-6-23
              ...
              Obx(() {
                return controller.isLoadMore.value? Container(color: Colors.white,
                  child: Row(
        ...
        : GridView.builder(
            ...
            itemBuilder: (context, index) => GestureDetector(
              onTap: () async {
                ...
                await Posthog().capture(eventName: 'view_product_detail',properties: {
                  'product_id': controller.productList[index].id.toString(),
                  'product_name': controller.productList[index].name.toString(),
