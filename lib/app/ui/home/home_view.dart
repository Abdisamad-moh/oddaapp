                    ...
                    GestureDetector(
                      ...
                      child: Stack(
                        children: [
                          ...
                          Obx(
                            () => controller.isNewNotification.value
                                ? Container(
                    ...
                    children: [
                      ...
                      Obx(
                        () => controller.isBannerLoading.value
                            ? SizedBox(height: 66.w, child: buildLoader())
                            : buildCarousel(),
                      ),
                      SizedBox(height: 2.h),
                      Obx(
      ...
      itemBuilder: (BuildContext context, int itemIndex, int pageViewIndex) =>
          GestureDetector(
            onTap: () async {
              if (controller.bannerList[itemIndex].has_product) {
                await Posthog().capture(
                  eventName: 'on_banner_click',
                  properties: {
                    'banner_id': controller.bannerList[itemIndex].id.toString(),
                    'user_id': getValue(SharedPref.userId),
                    'user_name': getValue(SharedPref.userName),
                    'mobile_no': getValue(SharedPref.mobileNo),
                  },
                ...
                Get.toNamed(
                  ...
                  arguments: {
                    ...
                    'ad_id': "",
                    'isBannerproduct':
                        controller.bannerList[itemIndex].is_banner ?? true,
                  },
                );
              }
            },
